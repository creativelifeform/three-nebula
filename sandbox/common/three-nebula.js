...
/*!********************************!*\
  !*** ./src/constants/index.js ***!
  \********************************/
/*! exports provided: PI, POOL_MAX, TIME_STEP, DR, MEASURE, EULER, RK2, RK4, VERLET, BIND_EMITTER_EVENT */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(System, [{
    ...
    value: function emit(_ref) {
      ...
      if (onUpdate) {
        this.eventDispatcher.addEventListener(_events__WEBPACK_IMPORTED_MODULE_2__["SYSTEM_UPDATE"], onUpdate);
      }
      ...
      if (this.canUpdate) {
        if (d > 0) {
          ...
          while (i--) {
            ...
            emitter.update(d);
            emitter.isEmitting && this.dispatch(_events__WEBPACK_IMPORTED_MODULE_2__["SYSTEM_UPDATE"]);
          }
        }
    ...
    value: function fromJSONAsync(json, THREE) {
      var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
          _ref2$shouldAutoEmit = _ref2.shouldAutoEmit,
          shouldAutoEmit = _ref2$shouldAutoEmit === void 0 ? false : _ref2$shouldAutoEmit;
...
/* harmony default export */ __webpack_exports__["default"] = (function (json, THREE, System, Emitter) {
  var _ref3 = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {},
      _ref3$shouldAutoEmit = _ref3.shouldAutoEmit,
      shouldAutoEmit = _ref3$shouldAutoEmit === void 0 ? true : _ref3$shouldAutoEmit;
...
function (_Particle) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Emitter, [{
    ...
    value: function addOnEmitterDeadEventListener(onEmitterDead) {
      this.eventDispatcher.addEventListener("".concat(this.id, "_").concat(_events__WEBPACK_IMPORTED_MODULE_6__["EMITTER_DEAD"]), function () {
    ...
    value: function destroy() {
      ...
      if (this.particles.length == 0) {
        ...
        this.removeAllBehaviours();
        this.dispatch("".concat(this.id, "_").concat(_events__WEBPACK_IMPORTED_MODULE_6__["EMITTER_DEAD"]));
