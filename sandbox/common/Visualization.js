...
window.Visualization = class {
  ...
  updateStats() {
    ...
    // this.particleStats.update(
    //   this.particleSystem.renderers[0].container.children.length,
    //   100
    // );
    this.stats.end();
  }
  ...
  async makeParticleSystem() {
    ...
    var particleContainer = vars.buffered
      ? new BufferedScene()
      : new THREE.Scene();
    scene.add(
      vars.buffered ? particleContainer.system.points : particleContainer
    );
